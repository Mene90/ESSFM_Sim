function [y1, y2] = essfm(xx,xy,Px,Tc,alf,bt2,gm,L,Ns,nl_step,C)
...
switch nl_step
    case {'filt','filtr'},
        [y1,y2]=nlstep_min(-geff(1)*C,transpose(y1),transpose(y2));
...
%   nonlinear step:
    switch nl_step
        case {'filt','filtr'},
            [y1,y2]=nlstep_min(-geff(n)*C,transpose(y1),transpose(y2));
        case {'quadform','quadformr'},
