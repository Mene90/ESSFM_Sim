function [ data ] = BER_ESSFM_Linear_XY( Nstep,NC,dBm,sym_length,n_prop_steps,etasp,nl_index)
...
n2        = nl_index;             % nonlinear index [m^2/W]
lambda    = 1550;                 % wavelength [nm] @ dispersion
D         = 17;                   % dispersion [ps/nm/km] @ wavelength
S         = 0;                    % slope [ps/nm^2/km] @ wavelength

Ns_prop   = n_prop_steps;         % # SSFM propagation step
Nspan     = 40;                   % total number of amplifiers/spam
